...
// MACAddress returns the MAC address (string) that the VM is expected to use
// when originating traffic on the vmnet interface.
func (h *Helper) MACAddress() string {
	return h.macAddress
}
